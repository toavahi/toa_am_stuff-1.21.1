...
public class AmBrushItem extends BrushItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if(!world.isClient()) {
            ...
            boolean b = true;
            if (context.getStack().get(ModDataComponents.COLOR) != 1F && context.getStack().get(ModDataComponents.COLOR) != 0) {
            ...
            if(b){
                ...
                ToaAmethystStuff.LOGGER.info("test");
            }
        }
        return super.useOnBlock(context);
    }

    public void placeShulker(World world, Block block, BlockPos pos, BlockState state){
    ...
    public void placeBed(World world, BlockPos pos, BlockState state, BlockState newState, PlayerEntity player) {
